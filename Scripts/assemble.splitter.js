    ...
    $.fn.splitter = function (args) {
        ...
        return this.each(function () {
            ...
            function resize(size) {
                ...
                if (splitter._oldW == splitter.width() && splitter._oldH == splitter.height() && !size)
            ...
            splitter
                ...
                .bind("resize" + opts.eventNamespace, function (e, size) { e.stopPropagation(); resize(size); })
                .bind("resizeSplitter", function (e, size) { e.stopPropagation(); resize(size); })
